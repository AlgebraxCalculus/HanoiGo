...
public class UserApi {
    private static final String USER_URL = "http://192.168.134.5:8080/api/users";
    private static final String ACHIEVEMENT_URL = "http://192.168.134.5:8080/api/achievements";
