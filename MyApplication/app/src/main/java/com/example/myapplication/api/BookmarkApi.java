...
public class BookmarkApi {
    private static final String BOOKMARK_LIST_URL = "http://192.168.1.3:8080/api/bookmark-lists";
    private static final String BOOKMARK_URL = "http://192.168.1.3.50:8080/api/bookmarks";
